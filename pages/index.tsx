...
const menuItems = [
  {
    name: "FISH TACO",
    desc: "Beer-battered fish, shredded cabbage, chipotle crema, pico de gallo, corn tortilla.",
  },
  {
    name: "SHRIMP TACO",
    desc: "Grilled shrimp, avocado salsa, pickled onion, cilantro, flour tortilla.",
  },
  {
    name: "BAJA BURRITO",
    desc: "Crispy fish, rice, black beans, cabbage, chipotle crema, wrapped tight.",
  },
  {
    name: "CEVICHE TOSTADA",
    desc: "Fresh fish ceviche, lime, cucumber, serrano, avocado, crispy tostada.",
  },
];
...
const Home: NextPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setSubmitted(true);
    setShowPopup(true);
    window.location.href = `mailto:hello@ensenada101.com?subject=Notify%20Me&body=Hi!%20Please%20add%20me%20to%20the%20list.%20My%20email%3A%20${encodeURIComponent(email)}`;
    setEmail("");
  };
  ...
  return (
    <>
      <Head>
        <title>Ensenada 101 — Fish Tacos &amp; Burritos — Roma Sur, CDMX</title>
      </Head>
      ...
      {showPopup && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative bg-teal-950 border border-white/10 rounded-xl p-8 sm:p-10 max-w-sm w-full text-center shadow-2xl"
          >
            <button
              onClick={() => setShowPopup(false)}
            ...
            <div className="w-14 h-14 rounded-full bg-teal-600/10 flex items-center justify-center mx-auto mb-5">
              <svg className="w-7 h-7 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <p className="text-2xl font-bold text-white font-display uppercase">You&apos;re on the list.</p>
            ...
            <a
              ...
              className="mt-6 inline-flex items-center justify-center gap-2.5 w-full bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white font-bold py-3.5 rounded-full text-sm uppercase tracking-wider transition-all duration-200 hover:opacity-90 active:scale-[0.98]"
            >
      ...
      >
        {/* Background photo — the iconic sign */}
        ...
        >
          ...
          >
            Fish Tacos
            <br />
            <span className="text-teal-300">&amp; Burritos</span>
          </motion.h1>
          ...
          >
            Ensenada-style. Coming soon to Roma Sur, CDMX.
          </motion.p>
          ...
          <div className="max-w-5xl mx-auto">
              ...
              <FadeIn>
                <div>
                  ...
                  <h2 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase tracking-wide text-neutral-900 leading-[0.95]">
                    Ensenada Style.
                    <br />
                    <span className="text-teal-600">No Shortcuts.</span>
                  </h2>
                </div>
              </FadeIn>
              <FadeIn delay={0.15}>
            ...
            <div className="mt-14 md:mt-20 grid md:grid-cols-3 gap-10">
              {[
                {
                  title: "Beer-Battered",
                  text: "Fresh white fish, dipped in our house batter and fried golden. Crispy outside, tender inside.",
                  icon: (
                ...
                {
                  title: "Fresh Salsas",
                  text: "Made from scratch every morning. Chipotle crema, pico de gallo, avocado salsa verde. Always fresh.",
                  icon: (
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                ...
                {
                  title: "Baja Tradition",
                  text: "Born on the streets of Ensenada. The original Baja fish taco, perfected and brought to CDMX.",
                  icon: (
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <FadeIn>
              <p className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide text-white text-center leading-tight drop-shadow-lg">
                From Ensenada
                <br />
                <span className="text-teal-300">to Your Table.</span>
              </p>
            </FadeIn>
          </div>
        </section>
            ...
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mt-4 text-neutral-500 max-w-lg mx-auto">
                  Ensenada&apos;s finest, made fresh daily. Simple ingredients, bold flavors.
                </p>
              </div>
            </FadeIn>
              ...
              <FadeIn>
                <div>
                  ...
                  <p className="mt-3 text-neutral-400">
                    Same rooftop, different vibe.
                    <br />
                    <span className="text-teal-600 font-semibold">Under the same roof as Juanberto&apos;s.</span>
                  </p>
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <FadeIn delay={0.1}>
              ...
              <p className="mt-5 text-sm text-white/30">
                Fresh off the coast. Watch us build it.
              </p>
            </FadeIn>
          </div>
        </section>
