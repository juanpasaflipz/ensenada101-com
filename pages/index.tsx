...
const Home: NextPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setError("");
    setSubmitted(true);
    window.location.href = `mailto:hello@ensenada101.fishtacos.com?subject=Notify%20Me&body=Hi!%20Please%20add%20me%20to%20the%20list.%20My%20email%3A%20${encodeURIComponent(email)}`;
    setEmail("");
  };
